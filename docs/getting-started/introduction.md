...
- **Internationalization** - 24 languages, three of them right-to-left, with auto-detection and configurable locale URL prefix via `NEXT_PUBLIC_LOCALE_PREFIX`
