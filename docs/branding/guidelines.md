...
<div style="display: flex; gap: 1.5rem; flex-wrap: wrap; align-items: center; margin: 1.5rem 0;">
  <div style="padding: 1.5rem; background: #f8f8f8; border-radius: 12px; text-align: center;">
    <img src="/branding/logo/Bulwark%20Logo%20Color.svg" alt="Bulwark Logo Color" style="width: 80px; height: 80px;" />
    <div style="margin-top: 0.5rem; font-size: 0.75rem; color: #888;">SVG</div>
  </div>
  <div style="padding: 1.5rem; background: #1a1a2e; border-radius: 12px; text-align: center;">
    <img src="/branding/logo/Bulwark%20Logo%20Color.svg" alt="Bulwark Logo Color" style="width: 80px; height: 80px;" />
    <div style="margin-top: 0.5rem; font-size: 0.75rem; color: #aaa;">SVG</div>
  </div>
</div>
...
<div style="display: flex; gap: 1.5rem; flex-wrap: wrap; align-items: center; margin: 1.5rem 0;">
  <div style="padding: 1.5rem; background: #f8f8f8; border-radius: 12px; text-align: center;">
    <img src="/branding/logo/Bulwark%20Logo%20Dark.svg" alt="Bulwark Logo Dark" style="width: 80px; height: 80px;" />
    <div style="margin-top: 0.5rem; font-size: 0.75rem; color: #888;">SVG</div>
  </div>
</div>
...
<div style="display: flex; gap: 1.5rem; flex-wrap: wrap; align-items: center; margin: 1.5rem 0;">
  <div style="padding: 1.5rem; background: #1a1a2e; border-radius: 12px; text-align: center;">
    <img src="/branding/logo/Bulwark%20Logo%20White.svg" alt="Bulwark Logo White" style="width: 80px; height: 80px;" />
    <div style="margin-top: 0.5rem; font-size: 0.75rem; color: #aaa;">SVG</div>
  </div>
</div>
...
<div style="display: flex; gap: 1.5rem; flex-wrap: wrap; align-items: center; margin: 1.5rem 0;">
  <div style="padding: 1.5rem; background: #f8f8f8; border-radius: 12px; text-align: center;">
    <img src="/branding/logo-with-lettering/Bulwark%20Logo%20with%20Lettering%20Dark%20Color.svg" alt="Bulwark Logo with Lettering Dark" style="height: 60px;" />
    <div style="margin-top: 0.5rem; font-size: 0.75rem; color: #888;">SVG</div>
  </div>
</div>
...
<div style="display: flex; gap: 1.5rem; flex-wrap: wrap; align-items: center; margin: 1.5rem 0;">
  <div style="padding: 1.5rem; background: #1a1a2e; border-radius: 12px; text-align: center;">
    <img src="/branding/logo-with-lettering/Bulwark%20Logo%20with%20Lettering%20White%20and%20Color.svg" alt="Bulwark Logo with Lettering White" style="height: 60px;" />
    <div style="margin-top: 0.5rem; font-size: 0.75rem; color: #aaa;">SVG</div>
  </div>
</div>

Download: [SVG](https://github.com/bulwarkmail/branding/raw/main/logo-with-lettering/Bulwark%20Logo%20with%20Lettering%20White%20and%20Color.svg) · [PNG](https://github.com/bulwarkmail/branding/raw/main/logo-with-lettering/Bulwark%20Logo%20with%20Lettering%20White%20and%20Color.png)

## Favicon

The Bulwark favicon for browser tabs and bookmarks.

<div style="display: flex; gap: 1.5rem; flex-wrap: wrap; align-items: center; margin: 1.5rem 0;">
  <div style="padding: 1.5rem; background: #f8f8f8; border-radius: 12px; text-align: center;">
    <img src="/branding/favicon/Bulwark%20Favicon.svg" alt="Bulwark Favicon" style="width: 48px; height: 48px;" />
    <div style="margin-top: 0.5rem; font-size: 0.75rem; color: #888;">SVG</div>
  </div>
  <div style="padding: 1.5rem; background: #1a1a2e; border-radius: 12px; text-align: center;">
    <img src="/branding/favicon/Bulwark%20Favicon.svg" alt="Bulwark Favicon" style="width: 48px; height: 48px;" />
